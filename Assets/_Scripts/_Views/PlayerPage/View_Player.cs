...
public class View_Player : UiBase
{
    ...
    private class View_info : UiBase
    {
        ...
        public void SetInfo(PlayerData player) => view_main.SetName($"{player}");
        public void SetSkills(PlayerData player) => view_skills.SetSkill(player.Skill, "技能");
        public void SetTags(PlayerData player) => view_tags.SetTags(player);
        ...
        private class View_tags : UiBase
        {
            ...
            public void SetTags(PlayerData player)
            {
